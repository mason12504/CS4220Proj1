...
// had to do this to get winsock2.h to compile
// includes the right library for winsock
...
int main(int argc, char* argv[])
{
    ...
    // this is actually so bad but the sample code uses a ton of gotos?
    goto test;
...
test:
    ...
    // if IPv6 = 1 then use IPv6, if IPv6 == 0 then use IPv4????
