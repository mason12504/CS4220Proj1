...
// project 1
// CS 4220
// This file tests some encryption with openSSL crypto libraries
// using OpenSSL libs at https://openssl-library.org/source/ ver 3.4.1
// Or Maybe Not

// this is some code from https://opensource.com/article/19/6/cryptography-basics-openssl-part-1
// that runs good on unix once you have openssl installed
// and do sudo apt install libssl-dev 

// it is a client that connects to google and gets some data from google using openSSL sockets
